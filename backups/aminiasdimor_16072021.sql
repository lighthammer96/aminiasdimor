...
-- Started on 2021-07-16 18:07:17
...
61	19	28	\N	nn	1	2021	2025	2	2	1	iglesias.division	Latinoamericana
\.
...
30	19	1424	2	2021-07-15	8
31	19	1424	2	2021-07-15	8
32	19	1424	2	2021-07-15	8
\.
...
19	0	0	\N	1	1	2	2		\N	TONY MARTIN	miembro_19.jpg	2021-07-01		M	14567888	Jr. Ricardo Palma 509	JR. RICARDO PALMA 509	957459877	959543793	jm.zs@hotmail.com	\N	2	2021-07-01	1	\N	N	1	0	2	\N	1	2021-07-14 00:00:00	\N	ASUNCION	DE LA GARZA ZAVALETA	31	202	\N	\N	\N	31	1	1	1	1	1	iglesias.otrospastores	1
18	0	0	1761	1	1	32	1		\N	JULISSA	miembro_18.jpg	1996-06-12		M	76621421	Jr. Ricardo Palma 509	JR. RICARDO PALMA 509	957459877	959543793	jm.zs@hotmail.com	\N	7	2021-07-11	1	\N	N	1	0	2	\N	1	2021-07-14 00:00:00	\N	TARAPOTO	GRANDES DIAZ	22	183	\N	\N	\N	32	1	1	1	1	1	iglesias.otrospastores	1
\.
...
1	juli	$2y$10$XUz4kvIUF95fVhBP3ANVwOjlqDY/C33ulZZzmoD0yFjcud4I3zNB.	admin	admin	22	A	18	5
\.
...
SELECT pg_catalog.setval('iglesias.cargo_miembro_idcargomiembro_seq', 61, true);
...
SELECT pg_catalog.setval('iglesias.control_traslados_idcontrol_seq', 8, true);
...
SELECT pg_catalog.setval('iglesias.historial_traslados_idtraslado_seq', 32, true);
...
SELECT pg_catalog.setval('iglesias.miembro_idmiembro_seq', 21, true);
...
SELECT pg_catalog.setval('iglesias.temp_traslados_idtemptraslados_seq', 193, true);
...
SELECT pg_catalog.setval('seguridad.log_sistema_idlog_seq', 628, true);
...
SELECT pg_catalog.setval('seguridad.modulos_modulo_id_seq', 36, true);
...
-- Completed on 2021-07-16 18:07:19
