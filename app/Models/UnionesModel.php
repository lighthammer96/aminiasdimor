...
class UnionesModel extends Model
{
    ...
    public function tabla() {
        ...
        $this->tabla->agregarColumna("u.descripcion", "descripcion", trans('traductor.descripcion'));
       // $this->tabla->agregarColumna("p.pais_descripcion", "pais_descripcion", trans('traductor.pais'));
        $this->tabla->agregarColumna("u.estado", "estado", trans('traductor.estado'));
