...
class PropuestasModel extends Model
{
    ...
    public function tabla() {
        ...
        $tabla->agregarColumna("pt.pt_titulo", "pt_titulo", traducir("asambleas.titulo"));
        ...
        $tabla->setSelect("pt.pt_id, ".formato_fecha_idioma(" pt.pt_fecha")." AS pt_fecha, pt.pt_correlativo, pt.pt_titulo, p.pais_descripcion AS pais, pt.lugar, CASE 
    ...
    public function tabla_propuestas_elecciones() {
        ...
        $tabla->agregarColumna("pe.pe_descripcion", "pe_descripcion", traducir("traductor.descripcion"));
        $tabla->agregarColumna("pe.pe_idioma", "pe_idioma", traducir("traductor.idioma"));
        ...
        $tabla->setSelect("pe.pe_id, ".formato_fecha_idioma(" pe.pe_fecha")." AS pe_fecha, pe.pe_descripcion, pe.pe_idioma, CASE 
