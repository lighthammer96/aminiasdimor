...
<!--                         
                ...
                <div class="modal-footer">
                    ...
                    <div class="pull-right">
                        ...
                        <button type="button" class="btn btn-default btn-sm" id="cancelar-resolucion"><img style="width: 20px; height: 20px;" src="{{ URL::asset('images/iconos/cancelar.png') }}" ><br>[Esc] [{{ traducir('traductor.cancelar')}}]</button>
                        <button type="button" id="guardar-resolucion" class="btn btn-default btn-sm"><img style="width: 20px; height: 20px;" src="{{ URL::asset('images/iconos/salvar.png') }}" ><br>[F9] [{{ traducir('traductor.guardar')}}]</button>
                    </div>
                </div>
            </form>
