        ...
        <div class="modal-content">
            ...
            <form id="formulario-tipos_cargo" class="form-horizontal" role="form">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-sm" id="cancelar-tipo-cargo">[Esc] [{{ traducir('traductor.cancelar')}}]</button>
                    <button type="button" id="guardar-tipo-cargo" class="btn btn-primary btn-sm">[F9] [{{ traducir('traductor.guardar')}}]</button>
                </div>
            </form>
