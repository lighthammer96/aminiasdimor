...
<head>
    ...
    <title>Listado de Propuestas Elecciones</title>
    <style>
    ...
    <main>
        ...
        <div class="row" style="margin-top: 10px; margin-bottom: 20px; text-align: center; font-size: 25px !important;">
            <div class="col" style="width: 100%;">
                <h3><?php echo mayusculas(traducir("asambleas.listado_propuestas_elecciones")); ?></h3>
            </div>
        </div>
            ...
            <div class="col" style="width: 100%;">
                <table border="1" style="width: 100%;">
                    <thead>
                        <tr>
                            <?php 
                                $headers = (array)$propuestas[0];
                                $keys = array_keys($headers);
                                // print_r($keys); exit;
                                for ($i=0; $i < count($keys) ; $i++) { 
                                    if($keys[$i] == "correlativo" || $keys[$i] == "detalle_propuesta" || $keys[$i] == "de" || $keys[$i] == "estado_propuesta") {
