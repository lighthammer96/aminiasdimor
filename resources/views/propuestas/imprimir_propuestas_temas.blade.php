...
<head>
    ...
    <title>Listado de Propuestas Temas</title>
    <style>
    ...
    <main>
        ...
        <div class="row" style="margin-top: 10px; margin-bottom: 20px; text-align: center; font-size: 25px !important;">
            <div class="col" style="width: 100%;">
                <h3><?php echo mayusculas(traducir("asambleas.listado_propuestas_temas")); ?></h3>
            </div>
        </div>
                        ...
                        <tr>
                            <?php 
                                ...
                                for ($i=0; $i < count($keys) ; $i++) { 
                                    if($keys[$i] == "correlativo" || $keys[$i] == "titulo" || $keys[$i] == "de" || $keys[$i] == "estado_propuesta") {
