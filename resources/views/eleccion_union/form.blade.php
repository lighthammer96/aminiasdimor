<div id="modal-eleccion_union" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none" data-backdrop="static">
    <div class="modal-dialog  modal-lg">
        <div class="modal-content">
            ...
            <form id="formulario-eleccion_union" class="form-horizontal" role="form">
                ...
                <input type="hidden" name="tipo" class="input-sm entrada" default-value="U">
                    <div class="row">
                    ...
                    <div class="row" style="margin-top: 10px;">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control input-sm entrada" name="comentarios"  cols="30" rows="2"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3" style="">
                            ...
                            <select class="entrada form-control input-sm select limpiar-oficiales" name="idcargo_union" id="idcargo_union">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-sm" id="cancelar-eleccion_union"><img style="width: 20px; height: 20px;" src="{{ URL::asset('images/iconos/cancelar.png') }}" ><br>[Esc] [{{ traducir('traductor.cancelar')}}]</button>
                    <button type="button" id="guardar-eleccion_union" class="btn btn-default btn-sm"><img style="width: 20px; height: 20px;" src="{{ URL::asset('images/iconos/salvar.png') }}" ><br>[F9] [{{ traducir('traductor.guardar')}}]</button>
                </div>
            </form>
