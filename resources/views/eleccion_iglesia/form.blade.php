        ...
        <div class="modal-content" >
            ...
            <form id="formulario-eleccion_iglesia" class="form-horizontal" role="form">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-sm" id="cancelar-eleccion_iglesia"><img style="width: 20px; height: 20px;" src="{{ URL::asset('images/iconos/cancelar.png') }}" ><br>[Esc] [{{ traducir('traductor.cancelar')}}]</button>
                    <button type="button" id="guardar-eleccion_iglesia" class="btn btn-default btn-sm"><img style="width: 20px; height: 20px;" src="{{ URL::asset('images/iconos/salvar.png') }}" ><br>[F9] [{{ traducir('traductor.guardar')}}]</button>
                </div>
            </form>
