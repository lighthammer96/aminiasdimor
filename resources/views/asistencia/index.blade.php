        ...
        <div class="modal-content">
            ...
            <form id="formulario-asistencia" class="form-horizontal" role="form">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-sm" id="cancelar-asistencia">[Esc] [{{ traducir('traductor.cancelar')}}]</button>
                    <button type="button" id="guardar-asistencia" class="btn btn-primary btn-sm">[F9] [{{ traducir('traductor.guardar')}}]</button>
                </div>
            </form>
